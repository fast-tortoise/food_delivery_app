                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 20,),
                        placesWidget("food1", "Special  Cutlet"),
                        SizedBox(height: 20,),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.end,
                          children: [
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              dishWidget("sushi", "Mix Cutlet", "5 Cutlets served in a row"),
                              dishWidget("suchi2", "Non-Veg  Cutlet", "5 Cutlets served in a row"),
                              dishWidget("sushi3", "Special  Cutlet", "5 Cutlets served in a row"),
                              dishWidget("sushi4", "Mix Cutlet", "5 Cutlets served in a row"),
                            ],
                          ),
                        )
                      ],
